...
public class RecentAdapter extends BaseAdapter {
    ...
    public RecentAdapter(Fragment context, List<StatusModel> arrayList, OnCheckboxListener onCheckboxListener) {
        ...
        // Pre-build Glide options for fast thumbnail loading
    ...
    public View getView(final int arg0, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.row_recent, null);
        ...
        boolean isVideo = Utils.isVideoFile(context.getActivity(), item.getFilePath());
